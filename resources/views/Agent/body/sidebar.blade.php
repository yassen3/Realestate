...
<nav class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a href="{{route('AgentDashboard')}}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="property">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route("agent.all.properties")}}" class="nav-link">All Property</a>
                </li>
                <li class="nav-item">
                  <a href="{{route("agent.add.properties")}}" class="nav-link">Add Property</a>
                </li>
