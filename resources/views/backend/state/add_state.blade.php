                                  ...
                                  <form method="POST" action="{{ route('store.state') }}" class="forms-sample" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">State Name </label>
                                                 <input type="type_name" name="state_name" class="form-control @error('state_name') is-invalid @enderror " id="state_name" autocomplete="off" >
                                                  @error('state_name')
                                                  ...
                                                  @enderror
                                                       ...
                                                       <div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="state_image" type="file" @error('state_image') is-invalid @enderror id="image">
                                                        @error('state_image')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
