            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Edit Property</h6>
                        <form method="post" action="{{ route('update.properties') }}"  id="myForm" enctype="multipart/form-data" >
                            @csrf
                             {{-- @method('POST') --}}
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Edit Main Thambnail</h6>
                                <form method="post" action="{{ route('update.properties.thambnail') }}"  enctype="multipart/form-data" >
                                    @csrf
                                    <input type="hidden" name="id" value="{{$properties->id}}">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title">Edit Multi Image Thambnail</h6>
                                        <form method="post" action="{{ route('update.properties.multiimage') }}"  enctype="multipart/form-data" >
                                            @csrf
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="submit" class="btn btn-primary px-4" value="Update Image">
                                                                <a href="{{route('delete.properties.multiimage',$img->id)}}" class="btn btn-danger" id="delete">Delete</a>
                                                            </td>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Edit Property Facilities</h6>
                                <form method="post" action="{{ route('update.properties.facilities') }}"  enctype="multipart/form-data" >
                                    @csrf
                                    <input type="hidden" name="id" value="{{$properties->id}}">
