                    ...
                    <h6 class="card-title">Add Property</h6>
                        <form method="post" action="{{ route('store.properties') }}"  enctype="multipart/form-data" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="lowest_price" class="form-control" placeholder="Enter Property name" @error('lowest_price') is-invalid @enderror>
                                        @error('lowest_price')
                                         <div class="text-danger">
                                            {{$message}}
                                         </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="max_price" class="form-control" placeholder="Enter Property name" @error('max_price') is-invalid @enderror>
                                        @error('max_price')
                                        <div class="text-danger">
                                           {{$message}}
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="file" name="multi_img[]" id="multiImg" class="form-control" multiple="" @error('multi_img[]') is-invalid @enderror >
                                        @error('multi_img[]')
                                        <div class="text-danger">
                                           {{$message}}
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="bedrooms" class="form-control" @error('bedrooms') is-invalid @enderror>
                                        @error('bedrooms')
                                        <div class="text-danger">
                                           {{$message}}
                                        </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="bathrooms" class="form-control" @error('bathrooms') is-invalid @enderror >
                                        @error('bathrooms')
                                        <div class="text-danger">
                                           {{$message}}
                                        </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="garage_size" class="form-control"@error('garage_size') is-invalid @enderror >
                                        @error('garage_size')
                                        <div class="text-danger">
                                           {{$message}}
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="property_size" class="form-control" @error('property_size') is-invalid @enderror>
                                        @error('property_size')
                                        <div class="text-danger">
                                           {{$message}}
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="property_video" class="form-control"@error('property_video') is-invalid @enderror >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="longtitude" class="form-control" @error('longtitude') is-invalid @enderror >
                                        @error('longtitude')
                                        <div class="text-danger">
                                           {{$message}}
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="agent_id" id="exampleFormControlSelect1" @error('agent_id') is-invalid @enderror>
                            ...
                            <div class="row add_item">
                                ...
                                <select name="facility_name[]" id="facility_name" class="form-control" @error('facility_name[]') is-invalid @enderror>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="distance[]" id="distance" class="form-control" placeholder="Distance (Km)" @error('distance[]') is-invalid @enderror>
                                        @error('distance[]')
                                        <div class="text-danger">
                                           {{$message}}
                                        </div>
