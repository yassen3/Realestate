                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-box">
                                ...
                                <div class="comment">
                                    <figure class="thumb-box">
                                        <img src="{{(!empty($com->user->photo)) ? url('upload/user_images/'.$com->user->photo) : url('upload/no_image.jpg')}}" alt="" style="width: 100px; height:100px;">
                                    </figure>
                             ...
                             @php
                                $replay = App\Models\Comment::where('parent_id',$com->id)->get();
                            ...
                            @foreach ($replay as $rep)
                                ...
                                <div class="comment replay-comment">
                                    <figure class="thumb-box">
                                        <img src="{{url('upload/itachi.jpg')}}" alt="">
                                    </figure>
                                    <div class="comment-inner">
                                        <div class="comment-info clearfix">
                                            <h5>{{$rep->subject}}</h5>
                    ...
                    <div class="blog-sidebar">
                        ...
                        <div class="sidebar-widget category-widget">
                            ...
                            <div class="widget-content">
                                <ul class="category-list clearfix">
                                 ...
                                 @php
                                    $posts = App\Models\BlogPost::where('blogcat_id',$cat->id)->get();
                                 @endphp
                                    <li><a href="{{url('blog/cat/list/'.$cat->id)}}">{{$cat->category_name}}<span>({{count($posts)}})</span></a></li>
                                    @endforeach
                        ...
                        <div class="sidebar-widget post-widget">
                            ...
                            <div class="post-inner">
                                ...
                                <div class="post">
                                    <figure class="post-thumb"><a href=""><img src="{{asset($post->post_image)}}" alt=""></a></figure>
