        ...
        <div class="top-inner clearfix">
            ...
            <div class="right-column pull-right">
                <ul class="social-links clearfix">
                    ...
                    <li><a href="{{$setting->email}}"><i class="fab fa-pinterest-p"></i></a></li>
...
@endphp
                    <ul class="social-links clearfix">
                  <li><a href="{{route('dashboard')}}"><i class="fab fa fa-envelope"></i>{{$userData->username}}</a></li>
                  <li><a href="{{route('user.logout')}}"><i class="fas fa-user"></i>Logout</a></li>
                </ul>
                </div>
                @else
                <div class="sign-box">
